...
- Educational simulator — do not claim CUDA/PagedAttention kernel implementation
- See `docs/ARCHITECTURE.md` for honest status boundaries
- Production inference → upstream [vLLM](https://github.com/vllm-project/vllm)
